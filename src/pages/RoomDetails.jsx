    ...
    room && (
      <div className="py-28 md:py-35 px-4 md:px-16 lg:px-24 xl:px-32">
        ...
        <form className="flex flex-col md:flex-row items-start md:items-center justify-between bg-white shadow-[0px_0px_20px_rgba(0,0,0,0.15)] p-6 rounded-xl mx-auto mt-16 max-w-6xl">
          ...
          <button
            type="submit"
            className="bg-primary hover:bg-primary-dull active:scale-95 transition-all text-white rounded-md max-md:w-full md:px-6 py-3 text-base cursor-pointer mt-4 md:mt-0"
          >
            Check Availability
          </button>
        </form>
        ...
        <div className="max-w-3xl border-gray-300 my-15 py-10 text-gray-500">
          <p>
            ...
            The price quoted is for 2 guests. Please mark the number of guests
